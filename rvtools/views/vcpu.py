...
#   print(queryset)
    return render(request, 'vcpu.html', context)


def export_csv(request):
    # 定义要导出的表格名称
    table_name = "rvtools_vcpu"
    # 查询要导出的表格数据
    ...
    response["Content-Disposition"] = 'attachment; filename="vcpu-list.csv"'
